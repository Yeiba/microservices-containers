...
mongosh mongodb://shard2svr1:27017 --eval "rs.status();" 2> /dev/null 

if [ ! $? -eq 0 ]; then
    echo =====================================
    echo seting up replicaSet ...
    echo =====================================
    mongosh mongodb://shard2svr1:27017 replicaSet.js
    sleep 5
    echo =====================================
    ...
    echo =====================================
    mongosh mongodb://shard2svr1:27017 --eval "rs.status();" 
else 
    echo =====================================
